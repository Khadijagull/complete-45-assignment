...
let quote:string = 'Nothing is impossible because impossible itself I Am Possible';

let author:string = "Khadija Gull";
...
let message:string = `${famousPerson} once said, "A person who never made a mistake tried andthing new."`;
...
let massage:string = `My Favorite Number is ${myFavoriteNumber}.`
...
// // in this program i add two number and print it
...
let myFriendsNames:string[] = ["nuosheen" , "Hafsa" , "HIra" , "Nayab" , "Reeha"];

for(let i = 0; i < myFriendsNames.length; i++) {

console.log(myFriendsNames[i]);
}
                //   Question no:12
// Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name.

 let myFriendNames:string[] = ["nuosheen" , "Hafsa" , "HIra" , "Nayab" , "Reeha"];
...
let guestList:string [] = ["nuosheen" , "Hafsa" , "HIra" , "Nayab" , "Reeha" ];

// //  for each method
guestList.forEach(guestName => {
    console.log(`Hello ${guestName}, you are cordially invited to dinner.`);
})


// map method

let additionalGuestList:string[] = guestList.map(guestName =>  `Hello ${guestName}, you are cordially invited to dinner.`);
...
if (name_1 != name_2){
    console.log("name are equal is Khadija Noor");
}

// • Tests using the lower case function
if (name_1 != name_3){
    console.log("name are equal Khadija gull");
}
...
make_shirt('large', "i love adidas!.");
...
const magician : string[] = ["bilawal","ali", "jamshed",'mohsin'];
...
const mycar : car = createcar("toyota","carolla",{ color : "black" , year : "2024"});
console.log(mycar);
